...
// RunC 根据入参运行容器进程
func RunC(cmdArry []string, imgName string, containerName string, createTTY bool) {
	processCmd, writePipe := container.NewContainerProcess(imgName, containerName, createTTY)
	if processCmd == nil {
